  ...
  useEffect(() => {
    ...
    const fetch = async () => {
      ...
      try {
        ...
        const base64String = btoa(String.fromCharCode(...new Uint8Array( getData.data.img.data.data)));
        setPath(`data:image/png;base64,${base64String}`);
            ...
            <Grid item container spacing={2} >
              <Grid item md={6} sm={6} xs={12}>
                <div className='center'>
                  <img className='img-large' src={path} alt={product.name} />
                </div>
              </Grid>
